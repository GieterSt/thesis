...
def get_clean_model_name(model_name):
    ...
    # Use EXACT mapping to avoid confusion
    name_mapping = {
        'deepseek-r1-0528-free': 'DeepSeek R1 (671B)',
        'deepseek-r1-distill-qwen-7b': 'DeepSeek Distill (7B)', 
        'claude-3-7-sonnet': 'Claude 3.7 (200B)',
        'llama-3.3-70b-instruct': 'Llama 3.3 (70B)',
        'mistral-7b-instruct': 'Mistral 7B (7.3B)'
    }
...
def create_thesis_visualizations(all_metrics, stats_results, timestamp):
    ...
    # Figure 1: Scaling Law Analysis (Hourly Success Rate)
...
def create_scaling_law_plot(df, timestamp):
    ...
    try:
        ...
        # Add model name annotations using clean names
