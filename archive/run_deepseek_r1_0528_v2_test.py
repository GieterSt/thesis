#!/usr/bin/env python3
"""
Test DeepSeek R1 0528 (free) on v2 clean dataset
"""
import json
import requests
import time
...
def main():
    ...
    print(f"   💰 Cost: FREE! (DeepSeek R1 0528 is completely free)")
    print(f"   🧠 Model: 671B parameters (37B active) - o1-level reasoning!")
    print(f"\n✅ Test completed!")
