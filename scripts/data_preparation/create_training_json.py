...
def create_training_json():
    """Convert training Excel data to JSON input/output pairs grouped by day"""
    
    # File paths
    training_file = "data/ground_truth/training_set_ground_truth_complete.xlsx"
    output_file = "data/ground_truth/training_ground_truth.json"
    ...
    print(f"Saved training ground truth to: {output_file}")
...
if __name__ == "__main__":
    training_json = create_training_json()
    print(f"\n✅ Training JSON ground truth creation completed!")
    print(f"📁 Output file: data/ground_truth/training_ground_truth.json") 