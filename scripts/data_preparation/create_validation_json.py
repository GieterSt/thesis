...
def create_validation_json():
    """Convert validation Excel data to JSON input/output pairs grouped by day"""
    
    # File paths
    validation_file = "data/ground_truth/validation_set_ground_truth_complete.xlsx"
    output_file = "data/ground_truth/validation_ground_truth.json"
    ...
    print(f"Loaded {len(df)} rows from validation dataset")
    ...
    print(f"Saved validation ground truth to: {output_file}")
...
if __name__ == "__main__":
    validation_json = create_validation_json()
    print(f"\n✅ Validation JSON ground truth creation completed!")
    print(f"📁 Output file: data/ground_truth/validation_ground_truth.json") 