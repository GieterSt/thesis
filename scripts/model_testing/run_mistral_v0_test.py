#!/usr/bin/env python3
"""
Test Mistral 7B Instruct (free) on v0 clean dataset
"""
import json
import requests
import time
...
OUTPUT_FILE = "results/model_outputs/mistralai_mistral-7b-instruct_free_results_v0_prompt.json"
...
def main():
    ...
    print(f"   💰 Cost: FREE! (Mistral 7B Instruct is completely free)")
    print(f"\n✅ Test completed!")
